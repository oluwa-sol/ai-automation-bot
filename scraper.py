...
TARGET_CATEGORIES = {
    ...
    "law firm":         "How are you currently handling new client inquiries when your team is tied up?",
    "lawyer":           "How are you currently handling new client inquiries when your team is tied up?",
    "real estate":      "How are you currently following up with leads who enquire but do not book right away?",
    "estate agent":     "How are you currently following up with leads who enquire but do not book right away?",
...
def scrape_maps(category: str, location: str, max_results: int = 50) -> list[dict]:
    leads = []
